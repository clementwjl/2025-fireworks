...
document.addEventListener('DOMContentLoaded', () => {
  const message = document.querySelector('.fireworks-message');
  
  // Assuming you have a function that starts the fireworks, add this:
  setTimeout(() => {
    message.style.animationPlayState = 'running';
  }, 1000); // Delay the message slightly to synchronize with the fireworks
});
